...
import { SearchResItem } from '@pages/area/landTopic/components/transferSelect/modules/templateModal/search/index';
import { getSearch } from '@pages/area/landTopic/components/transferSelect/utils';
