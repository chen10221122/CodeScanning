...
import { AREA_F9_PLEDGEE } from '@/configs/localstorage';
    ...
    <WrapperContainer
      ...
      headerBottomContent={
        <Filter
          ...
          dataKey={AREA_F9_PLEDGEE}
          handleSearch={handleSearch}
          condition={{ ...condition, module_type: 'receivable_financing_pledgee_stat' }}
          filename={`${areaInfo?.regionName || ''}地区-应收账款融资-按质权人/受让人-${dayjs().format('YYYY-MM-DD')}`}
        />
      }
    />
  );
