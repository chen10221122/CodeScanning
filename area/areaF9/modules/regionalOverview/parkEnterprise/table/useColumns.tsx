...
import ParkPopver from '../components/parkPopver';

const useColumn = (from: number, searchValue: string) => {
  const columns: TableColumnsType<TableData> = [
    ...
    {
      title: '所属园区',
      dataIndex: 'affiliationAreaList',
      key: 'affiliationAreaList',
      width: 197,
      resizable: true,
      align: 'left',
      render: (text, row) => <Park list={text} keywords={searchValue} />,
    },
    {
      title: '注册资本',
