...
import { RankItem } from '@/pages/area/areaF9/modules/regionalOverview/areaRank/api';
import { mapOrder, useCtx } from '@/pages/area/areaF9/modules/regionalOverview/areaRank/provider';
...
const Table = () => {
  ...
  const handlePageChange = useMemoizedFn((p) => {
    ...
    if (document.querySelector('.side-page-content')) {
      (document.querySelector('.side-page-content') as any).scrollTop = 0;
    }
    ...
    <div>
      ...
      {rankCount && rankCount > 50 ? (
        <Pagination
          ...
          style={{ padding: '8px 0px 14px', position: 'relative', left: '9px' }}
          align={'left'}
        />
      ) : (
