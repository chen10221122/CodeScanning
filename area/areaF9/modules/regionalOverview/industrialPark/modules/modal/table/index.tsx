...
const TableFinance = () => {
  ...
  const columns = useColumn(condition.from, condition.likeStr);
    ...
    <TableWrapper>
      <Table
        ...
        sticky={{
          ...
          getContainer: () => (document.querySelector('.dzh-modal-body-inner') as HTMLElement) || document.body,
        }}
