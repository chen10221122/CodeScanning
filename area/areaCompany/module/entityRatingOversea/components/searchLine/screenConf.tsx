...
export enum rankDirectEnum {
  up = '1',
  down = '2',
  same = '3',
}
export enum ratingOutlookEnum {
  '正面' = '1',
  '稳定' = '2',
  '负面' = '3',
  '列入评级观察（可能调高）' = '4',
...
const moreSelectors = [
  ...
  // },
  {
    title: '是否城投',
    data: [
      { name: '全部', value: '1,0', field: 'urbanInvest' },
      { name: '是', value: '1', field: 'urbanInvest' },
      { name: '否', value: '0', field: 'urbanInvest' },
    ],
    group: 2,
  },
  {
    ...
    multiple: true,
    data: [
      // { name: '中诚信国际', value: '80002154', field: 'ratingOrgCode' },
      // { name: '中诚信评估', value: '80000858', field: 'ratingOrgCode' },
      // { name: '中证鹏元', value: '80002099', field: 'ratingOrgCode' },
      // { name: '远东资信', value: '80002101', field: 'ratingOrgCode' },
      // { name: '联合评级', value: '80129270', field: 'ratingOrgCode' },
      // { name: '大公国际', value: '80002192', field: 'ratingOrgCode' },
      // { name: '新世纪评级', value: '80062388', field: 'ratingOrgCode' },
      // { name: '联合资信', value: '80002172', field: 'ratingOrgCode' },
      // { name: '东方金诚', value: '80117870', field: 'ratingOrgCode' },
      // { name: '中债资信', value: '80160465', field: 'ratingOrgCode' },
      // { name: '上海资信', value: '80087311', field: 'ratingOrgCode' },
      { name: '穆迪评级', value: '80065841', field: 'ratingOrgCode' },
      { name: '标普评级', value: '80058815', field: 'ratingOrgCode' },
      // { name: '标普中国', value: '81625944', field: 'ratingOrgCode' },
      { name: '惠誉评级', value: '80065840', field: 'ratingOrgCode' },
    ],
    group: 3,
  },
];
