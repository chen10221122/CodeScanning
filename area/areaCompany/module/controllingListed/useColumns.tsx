...
import TableTooltip from '../../components/tableCpns/toolTip';
  ...
  return ({ curPage, restParams }: { curPage: number; restParams: any }) => {
    return useCreation(
      () => [
        ...
        {
          title: (
            <span title="参控上市公司数" className="areaf9-tbl-header">
              参控上市公司数
              <TableTooltip
                title="参控上市公司是指参控在上交所、深交 所、北交所、港交所上市的企业"
                getPopupContainer={() => document.getElementById('ac59075b964b0715') || document.body}
                placement="bottom"
              />
            </span>
          ),
          key: 'listingOrgNum',
          dataIndex: 'listingOrgNum',
          sorter: true,
