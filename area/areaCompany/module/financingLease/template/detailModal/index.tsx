...
import CompanyEllipsis from './companyEllipsis';
...
const ModalWithTrendDetail: FC<IProps> = ({
  ...
  const columns = useMemo(
    ...
    [columnNeedBlank, currentPage, indicatorColumns, paginationSize],
  );
  ...
  return (
    <FullModal
      visible={visible}
      container={container || document.querySelector('#censusAnalyseMountedId') || document.body}
      title={[modalTitle]}
      className={cn(S.detailModalWrapper, className)}
