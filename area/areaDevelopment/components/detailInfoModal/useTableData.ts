    ...
    if (data?.list) {
      ...
      data.list.forEach((indicatorItem: any) => {
        ...
        indicatorItem?.itemList.forEach((item: any) => {
          const { DisplayCunit, Mvalue, Guid, PosID, IndicName2 } = item;
          obj[IndicName2] = { DisplayCunit, Mvalue, Guid, PosID };
        });
      });
      ...
      indicatorListPick.forEach((ite) => {
        ...
        if (conditionInChildNewSet.length) {
          ...
          years.forEach((year) => {
            ...
            titleObj[year + '_PosID'] = defaultIndicator.PosID;
          });
          ...
          conditionInChildNewSet.forEach((str) => {
            ...
            years.forEach((year) => {
              ...
              assembledObject[year + '_PosID'] = middleIndicator.PosID;
