...
import Intro from '@/components/dialog/helpUpdateRemind';
...
const TitleWithBackImg: FC<Props> = ({ backgroundImg, title, info }) => {
  const uInfo = useSelector((store: IRootState) => store.user.info);
  return (
    <TitleWithImg style={{ backgroundImage: `url(${backgroundImg})` }}>
