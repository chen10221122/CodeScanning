...
import reloadBgOne from './reload-bg-one.png';
import reloadBg from './reload-bg.png';
import reloadLoading from './reload-loading.png';
...
const PhoneQrcode: FC<Prop> = ({
  ...
  const [appImgError, { setTrue: setAppImgErrorTrue, setFalse: setAppImgErrorFalse }] = useBoolean(false);
  const [qrImgError, { setTrue: setQrImgErrorTrue, setFalse: setQrImgErrorFalse }] = useBoolean(false);
  ...
  }, [appQrcodeSrc, setAppImgErrorFalse, setAppImgErrorTrue]);
  ...
  }, [appletQrcodeSrc, setQrImgErrorFalse, setQrImgErrorTrue]);
