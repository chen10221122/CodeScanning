...
import { getRankDetail, RankDetailApiData, RankDetailItem } from '@/pages/area/areaEconomy/modules/areaRank/api';
              ...
              onClick={() => {
                if (isCorrectArea(item.areaCode)) {
                  handleLimit(item.areaCode, () => {
                    history.push(urlJoin(dynamicLink(LINK_AREA_F9, { key: 'regionEconomy', code: item.areaCode })));
                  });
                }
              }}
