    ...
    () => ({
      tooltip: {
        ...
        formatter: (params: any) => {
          ...
          return `<div style='width: 172px'><div style='margin-bottom: 4px;'>${name}</div><div style='display: flex; align-items: center; justify-content: space-between;'>${content}</div></div>`;
        },
      },
      series: [
        {
